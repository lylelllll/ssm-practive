            ...
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <c:forEach items="${list}" var="bankcard">
                                    <tr>
                                        <th scope="row">${bankcard.id}</th>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="/ssmDemo/toUpdatebankcard?id=${bankcard.id}"><button class="dropdown-item" type="button">修改</button></a>
                                                    <a href="/ssmDemo/deletebankcard?id=${bankcard.id}"><button class="dropdown-item" type="button">删除</button></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item"><a class="page-link" href="javascript:jump(1)">首页</a></li>
                        <li class="page-item"><a class="page-link" href="javascript:jump(${pageInfo.prePage})">上一页</a></li>
                        <li class="page-item"><a class="page-link" href="javascript:jump(${pageInfo.pageNum})">${pageInfo.pageNum}</a></li>
                        <li class="page-item"><a class="page-link" href="javascript:jump(${pageInfo.nextPage})">下一页</a></li>
                        <li class="page-item"><a class="page-link" href="javascript:jump(${pageInfo.pages})">尾页</a></li>
                    </ul>
                </nav>
