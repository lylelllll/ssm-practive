    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">修改银行信息</h5>
                        <form action = "/ssmDemo/updateBank" method = "post">
                            <input type="hidden" name="id" value="${bank.id}">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Bankname</label>
                                <div class="col-sm-10">
                                    <input name="name" type="text" class="form-control" id="inputEmail3" placeholder="Username" value="${bank.name}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">assets</label>
                                <div class="col-sm-10">
                                    <input name="assets" type="text" class="form-control" id="inputPassword3"
                                           placeholder="Password" value="${bank.assets}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-10">
